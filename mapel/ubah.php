...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Ubah Data Mata Pelajaran</title>
									...
									<form action="proses_ubah.php?id=<?php echo $mapel['id'] ?>" method="POST">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="guru_pengampu" class="form-control" placeholder="Masukan Guru Pengampu" name="guru_pengampu" autocomplete="off" required="required" value="<?php echo $mapel['guru_pengampu'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="ruangan" class="form-control" placeholder="Masukan Ruangan" name="ruangan" autocomplete="off" required="required" value="<?php echo $mapel['ruangan'] ?>">
											</div>
										</div>
										<div class="form-group">
