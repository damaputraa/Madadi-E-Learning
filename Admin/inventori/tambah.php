...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Tambah Data Inventori</title>
									...
									<form action="proses_tambah.php" method="POST">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="nama_barang" class="form-control" placeholder="Masukan Nama Barang" name="nama_barang" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="number" id="jumlah_barang" class="form-control" placeholder="Masukan Jumlah Barang" name="jumlah_barang" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
